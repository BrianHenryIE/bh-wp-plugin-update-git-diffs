<?php
/**
 * Tests for BH_WP_Plugin_Update_Git_Diffs main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BH_WP_Plugin_Update_Git_Diffs_Integration_Test extends \Codeception\TestCase\WPTestCase {
